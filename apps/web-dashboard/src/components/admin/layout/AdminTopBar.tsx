        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="leading-tight">
              <div className="text-sm font-semibold text-[var(--adm-ink)]">
                {t('nav.admin.brand', 'NER LogiSense')}
              </div>
              <div className="text-[11px] text-[var(--adm-ink-3)] hidden sm:block">
                {t('nav.admin.consoleLabel', 'Administration Console')}
              </div>
            </div>
          </div>
        </div>
